...
@Config
@Autonomous(name="cyclered", group="Tutorials")
...
//        DcMotorEx intake=hardwareMap.get(DcMotorEx.class, "intake");
        ...
        Trajectory traj = drive.trajectoryBuilder(start)
                .lineToLinearHeading(new Pose2d(3, 41, Math.toRadians(100)))
                .addTemporalMarker(0,()->{
                    intake.setPower(0.1); // 0.1
                })
                .addTemporalMarker(0,()->{
...
//                .build();
        ...
        TrajectorySequence traj7V2 = drive.trajectorySequenceBuilder(traj7.end())
                .splineToLinearHeading(new Pose2d(6,38,Math.toRadians(100)),Math.toRadians(90))

                .build();

        TrajectorySequence traj8 = drive.trajectorySequenceBuilder(traj7V2.end())
                .splineToLinearHeading(new Pose2d(-12,64,Math.toRadians(180)),Math.toRadians(180))
                ...
                .forward(42)
                //EXPERIMENTAL IN AUTO A JUST TO TEST.
//                .turn(Math.toRadians(35)) --> we have decided we do not want to turn

                .build();

        TrajectorySequence traj7V3 = drive.trajectorySequenceBuilder(traj8.end())
                .back(45) // may need to incrase this distance pto 47
                .addTemporalMarker(0,()->{
                    linearslideleft.setTargetPosition(linearslideleft.getCurrentPosition()+6000);
                    linearslideleft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    linearslideright.setTargetPosition(linearslideright.getCurrentPosition()+6000);
        ...
        TrajectorySequence traj8V2 = drive.trajectorySequenceBuilder(traj7V4.end())
                .splineToLinearHeading(new Pose2d(-3,67,Math.toRadians(180)),Math.toRadians(180))
                .forward(43)
...
//        DcMotorEx intake=hardwareMap.get(DcMotorEx.class, "intake");
        ...
        Trajectory traj = drive.trajectoryBuilder(start)
                ...
                .addTemporalMarker(0,()->{
                    linearslideleft.setTargetPosition(linearslideleft.getCurrentPosition()+3700); // 3700
                    linearslideleft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
...
//        DcMotorEx intake=hardwareMap.get(DcMotorEx.class, "intake");
        ...
        drive.setPoseEstimate(start);
        Trajectory traj = drive.trajectoryBuilder(start)
                .lineToLinearHeading(new Pose2d(3, 40, Math.toRadians(100)))
                .addTemporalMarker(0,()->{
                    intake.setPower(0.1);
                })
                .addTemporalMarker(0,()->{
