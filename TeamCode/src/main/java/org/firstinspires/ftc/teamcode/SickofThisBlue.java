...
@Config
@Autonomous(name="SickofThisButBlue", group="Tutorials")
// written by a dumbass
// like a moron
// stupid person kind of thing
public class SickofThisBlue extends LinearOpMode {
...
//        DcMotorEx intake=hardwareMap.get(DcMotorEx.class, "intake");
        ...
        Trajectory trajstart = drive.trajectoryBuilder(start)
                .lineToLinearHeading(new Pose2d(3, 38, Math.toRadians(60)))
                .addTemporalMarker(0,()->{
                    intake.setPower(-0.1);
                })
                .addTemporalMarker(0,()->{
                ...
                .addTemporalMarker(0.9,()->{
                    actuator.setTargetPosition(actuator.getCurrentPosition()+1500);
                    actuator.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    actuator.setPower(1);
                })
        ...
        TrajectorySequence trajmain = drive.trajectorySequenceBuilder(start)
                .splineTo(new Vector2d(15,63.5),Math.toRadians(2))
                .forward(34.5)
                .back(34.5)
                .splineTo(new Vector2d(3,37.5),Math.toRadians(-120))
                //slow down intake
                .addTemporalMarker(4,()->{
                    intake.setPower(-0.4);
                })
                ...
                .addTemporalMarker(4,()->{
                    actuator.setTargetPosition(actuator.getCurrentPosition()+1600);
                    actuator.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    actuator.setPower(1);
                })
        ...
        TrajectorySequence traj2 = drive.trajectorySequenceBuilder(start)
                .splineTo(new Vector2d(15,65.5),Math.toRadians(2))
//                .waitSeconds(0.2)
                .forward(36)
                .back(36)
                .splineTo(new Vector2d(3,37.5),Math.toRadians(-120))
        ...
        TrajectorySequence traj3 = drive.trajectorySequenceBuilder(traj2.end())
                .splineTo(new Vector2d(15,67.5),Math.toRadians(2))
//                .waitSeconds(0.2)
                .forward(37.5)
                .back(37.5)
                .splineTo(new Vector2d(3,37.5),Math.toRadians(-120))
        ...
        TrajectorySequence traj4 = drive.trajectorySequenceBuilder(traj3.end())
                .splineTo(new Vector2d(17,-42),Math.toRadians(0))
                .forward(40)
                .addTemporalMarker(0,()->{
                    actuator.setTargetPosition(actuator.getCurrentPosition()-1600);
                    actuator.setMode(DcMotor.RunMode.RUN_TO_POSITION);
