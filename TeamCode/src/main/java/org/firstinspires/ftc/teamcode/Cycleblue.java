...
@Config
@Autonomous(name="cycleblue", group="Tutorials")

public class Cycleblue extends LinearOpMode {
...
//        DcMotorEx intake=hardwareMap.get(DcMotorEx.class, "intake");
        ...
        Trajectory traj = drive.trajectoryBuilder(start)
                .splineToLinearHeading(new Pose2d(-3, -34, Math.toRadians(-145)),Math.toRadians(-270))
                .addTemporalMarker(0,()->{
                    intake.setPower(0.1);
                })
                .addTemporalMarker(0,()->{
                    linearslideleft.setTargetPosition(linearslideleft.getCurrentPosition()+2800); // 2300
                    linearslideleft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    linearslideright.setTargetPosition(linearslideright.getCurrentPosition()+2800);
                    linearslideright.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    linearslideright.setPower(1);
                    linearslideleft.setPower(1);
                })
                .addTemporalMarker(1,()->{
                    actuator.setTargetPosition(actuator.getCurrentPosition()+1000);
                    actuator.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    actuator.setPower(1);
                })
        ...
        TrajectorySequence traj4 = drive.trajectorySequenceBuilder(traj.end())
                .splineToLinearHeading(new Pose2d(-5,-62,Math.toRadians(-180)),Math.toRadians(-180))
//
                .addTemporalMarker(0.7,()->{
                    linearslideleft.setTargetPosition(linearslideleft.getCurrentPosition()-2800);
                    linearslideleft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    linearslideright.setTargetPosition(linearslideright.getCurrentPosition()-2800);
                    linearslideright.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    linearslideright.setPower(1);
...
//                .build();
        TrajectorySequence traj7 = drive.trajectorySequenceBuilder(traj4.end())
                .back(42)
                .addTemporalMarker(0,()->{
                    linearslideleft.setTargetPosition(linearslideleft.getCurrentPosition()+6000);
                    linearslideleft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    linearslideright.setTargetPosition(linearslideright.getCurrentPosition()+6000);
                    linearslideright.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    linearslideright.setPower(1);
                    linearslideleft.setPower(1);
                })
                ...
                .build();
        TrajectorySequence traj7V2 = drive.trajectorySequenceBuilder(traj7.end())
                .splineToLinearHeading(new Pose2d(6,-31,Math.toRadians(-145)),Math.toRadians(-270))
                .build();

        TrajectorySequence traj8 = drive.trajectorySequenceBuilder(traj7V2.end())
                .splineToLinearHeading(new Pose2d(-5,-66,Math.toRadians(-180)),Math.toRadians(-180))
...
//                })
        ...
        TrajectorySequence traj7V3 = drive.trajectorySequenceBuilder(traj8.end())
                .back(44)
                .addTemporalMarker(0,()->{
                    linearslideleft.setTargetPosition(linearslideleft.getCurrentPosition()+6000);
                    linearslideleft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                ...
                .build();
        TrajectorySequence traj7V4 = drive.trajectorySequenceBuilder(traj7V3.end())
                .splineToLinearHeading(new Pose2d(6,-31,Math.toRadians(-145)),Math.toRadians(-270))
                .build();

        TrajectorySequence traj8V2 = drive.trajectorySequenceBuilder(traj7V4.end())
                .splineToLinearHeading(new Pose2d(-5,-72,Math.toRadians(-180)),Math.toRadians(-180))
                .forward(45)
//                .addTemporalMarker(0.5,()->{
//                    stopper.setPosition(0);
//                    intake.setPower(-1);
//                })
        ...
        drive.followTrajectorySequence(traj7V2);
...
//        drive.followTrajectory(traj9);
        ...
        drive.followTrajectorySequence(traj7V3);
        drive.followTrajectorySequence(traj7V4);
        ...
        //MOVE TO PICKUP
        drive.followTrajectorySequence(traj8V2);
//        drive.followTrajectory(traj9);
...
//        DcMotorEx intake=hardwareMap.get(DcMotorEx.class, "intake");
        ...
        Trajectory traj = drive.trajectoryBuilder(start)
                ...
                .addTemporalMarker(0,()->{
                    linearslideleft.setTargetPosition(linearslideleft.getCurrentPosition()+3700); //3200
                    linearslideleft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    linearslideright.setTargetPosition(linearslideright.getCurrentPosition()+3700);
                    linearslideright.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    linearslideright.setPower(1);
                    linearslideleft.setPower(1);
                })
...
//
                .addTemporalMarker(0.7,()->{
                    linearslideleft.setTargetPosition(linearslideleft.getCurrentPosition()-3700);
                    linearslideleft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    linearslideright.setTargetPosition(linearslideright.getCurrentPosition()-3700);
                    linearslideright.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    linearslideright.setPower(1);
...
//                .build();
        TrajectorySequence traj7 = drive.trajectorySequenceBuilder(traj4.end())
                .back(42)
                .addTemporalMarker(0,()->{
                    linearslideleft.setTargetPosition(linearslideleft.getCurrentPosition()+6000); // 5500
                    linearslideleft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    linearslideright.setTargetPosition(linearslideright.getCurrentPosition()+6000);
                    linearslideright.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    linearslideright.setPower(1);
...
//        DcMotorEx intake=hardwareMap.get(DcMotorEx.class, "intake");
        ...
        drive.setPoseEstimate(start);
        Trajectory traj = drive.trajectoryBuilder(start)
                .splineToLinearHeading(new Pose2d(6, -36, Math.toRadians(-120)),Math.toRadians(-270))
                .addTemporalMarker(0,()->{
                    intake.setPower(0.1);
                })
                .addTemporalMarker(0,()->{
...
//                .build();
        TrajectorySequence traj7 = drive.trajectorySequenceBuilder(traj4.end())
                ...
                .build();
        TrajectorySequence traj7V2 = drive.trajectorySequenceBuilder(traj7.end())
                .splineToLinearHeading(new Pose2d(6, -34.5, Math.toRadians(-120)),Math.toRadians(-270))
                .build();
